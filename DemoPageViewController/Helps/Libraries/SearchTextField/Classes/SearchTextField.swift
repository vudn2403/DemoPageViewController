...
open class SearchTextField: UITextField {
    ...
    open var highlightAttributes: [NSAttributedStringKey: AnyObject] = [.font: AppFont.fontWithType(.regular, size: 16)]
    ...
    fileprivate var fontConversionRate: CGFloat = 1
    ...
    fileprivate func buildPlaceholderLabel() {
        ...
        if let placeholderLabel = placeholderLabel {
            placeholderLabel.font = AppFont.fontWithType(.regular, size: 16)
    ...
    fileprivate func highlightAttributesForSubtitle() -> [NSAttributedStringKey: AnyObject] {
        ...
        for attr in highlightAttributes {
            if attr.0 == NSAttributedStringKey.font {
                ...
                highlightAttributesForSubtitle[attr.0] = AppFont.fontWithType(.regular, size: 16)
            } else {
...
extension SearchTextField: UITableViewDelegate, UITableViewDataSource {
    ...
    public func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell!.detailTextLabel?.font = AppFont.fontWithType(.regular, size: 16)
...
//        cell!.selectionStyle = .none
        ...
        backgroundView.backgroundColor = AppColor.colorLipStick()
        cell!.selectedBackgroundView = backgroundView
        
//        if indexPath.row % 2 == 0 {
//            cell?.backgroundColor = AppColor.colorLipStick()
//        } else {
//            cell?.backgroundColor = AppColor.colorLipStick()
//        }
        return cell!
...
public struct SearchTextFieldTheme {
    ...
    public static func lightTheme() -> SearchTextFieldTheme {
        return SearchTextFieldTheme(cellHeight: 44, bgColor: UIColor (red: 1, green: 1, blue: 1, alpha: 0.6), borderColor: UIColor (red: 0.9, green: 0.9, blue: 0.9, alpha: 1.0), separatorColor: UIColor.clear, font: AppFont.fontWithType(.regular, size: 16), fontColor: UIColor.black)
    }
    
    public static func darkTheme() -> SearchTextFieldTheme {
        return SearchTextFieldTheme(cellHeight: 44, bgColor: UIColor.clear, borderColor: UIColor.clear, separatorColor: AppColor.colorBorderBlack(), font: AppFont.fontWithType(.regular, size: 16), fontColor: UIColor.white)
    }
}
